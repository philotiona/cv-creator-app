...
export default function Address() {
    return(
        <div className={styles.wrapper}>
            <h1 id="contactsLink">Contacts</h1>
            ...
            <div className={styles.twitter}>
                ...
                <a href="https://twitter.com/intent/tweet?text=Hello%20world!" target="_blank"><strong>Twiiter</strong></a>           
            </div>
            <div className={styles.facebook}>
                ...
                <a href="https://www.facebook.com/sharer/sharer.php?u=https://example.com" target="_blank"><strong>Facebook</strong></a>
            </div>
