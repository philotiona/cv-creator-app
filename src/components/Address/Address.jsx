    ...
    return(
        <div className={styles.wrapper}>
            ...
            <div className={styles.twitter}>
                ...
                <p><strong>Twitter</strong><br />https://twitter.com/wordpress</p>            
            </div>
            <div className={styles.facebook}>
                ...
                <p><strong>Facebook</strong><br />https://www.facebook.com/facebook</p>
            </div>
            <div className={styles.skype}>
                ...
                <p><strong>Skype</strong><br />hello</p>
            </div>
            </div>
        </div>
    )
